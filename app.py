...
def main():
    print("🎬 ENHANCED IMDB CONTENT-BASED MOVIE RECOMMENDATION SYSTEM")
    print("🔧 WITH WEIGHTED RATING BIAS CORRECTION")
    print("=" * 75 + "\n")
    recommender = IMDBContentBasedRecommendationSystem()
    recommender.load_imdb_data('imdb_movies.csv')
    recommender.calculate_weighted_ratings()
    recommender.build_content_based_system()
    recommender.analyze_similarity_quality()
    recommender.create_comprehensive_visualizations()
    print(f"\n✨ NEW ENHANCEMENTS ADDED:")
    print("=" * 40)
    print("🎭 1. Search by Genre")
    print("👥 2. Search by Crew")
    print("🔍 3. Advanced Search")
    print("📋 4. Browse Genres")
    print("👑 5. Browse Popular Crew")
    print("🎯 6. Interactive Menu")
    ...
    recommender.interactive_recommendation_system()
    return recommender
